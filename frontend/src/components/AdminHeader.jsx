        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 max-w-md mx-8">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search users, tickets, or system logs..."
                className="w-full pl-10 pr-4 py-2.5 bg-gray-100/80 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500/30 text-sm placeholder-gray-500 transition-all duration-200"
              />
            </div>
          </div>
